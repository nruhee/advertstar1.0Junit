...
public class AdvertiserReceipts {


    public static final String REPORT_FILE_LOCATION = "/var/lib/jenkins/report/var/lib/jenkins/jobs/Advertstar1.0Test/workspace/reports/AdvertiserReceipts.html";
    ...
    @Test
    public void testAdvertiserReceipt() throws Exception {

        test = extent.startTest("Advertiser Receipt", "Testing of advertiser receipt panel");
        ...
        test.log(LogStatus.PASS, "By.linkTextСчета.click");
